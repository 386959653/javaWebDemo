...
public class RSAUtils {
    ...
    static {
        try {
            RSAKeyStore = ResourceUtils.getFile("classpath:").getAbsolutePath() + "/RSAKey.txt";
    ...
    public static String decode(String data) throws Exception {
        ...
        byte[] en_result = RSAUtils.hexStringToBytes(data);
        byte[] de_result = RSAUtils.decrypt(RSAUtils.getKeyPair().getPrivate(), en_result);
        StringBuilder str = new StringBuilder(new String(de_result));
        return str.toString();
    }
